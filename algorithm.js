...
const solve = async (equation) => {
    ...
    */
    ...
    let transform_data = { "0": { "to": [], "from": ["8"], "morph": ["6", "9"] }, "1": { "to": [], "from": ["7", "-1"], "morph": [] }, "2": { "to": [], "from": ["-2"], "morph": ["3", "5"] }, "3": { "to": [], "from": ["9", "-3"], "morph": ["2", "5"] }, "4": { "to": [], "from": ["-4"], "morph": [] }, "5": { "to": [], "from": ["9", "6", "-5"], "morph": ["3"] }, "6": { "to": ["5"], "from": ["8", "-6"], "morph": ["9", "0"] }, "7": { "to": ["1"], "from": ["-7"], "morph": [] }, "8": { "to": ["6", "9", "0"], "from": ["-8"], "morph": [] }, "9": { "to": ["3", "5"], "from": ["8", "-9"], "morph": ["6", "0"] }, "+": { "to": ["-"], "from": [], "morph": [] }, "-": { "to": [], "from": ["+"], "morph": [] } }
